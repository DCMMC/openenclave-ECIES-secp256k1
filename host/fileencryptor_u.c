...
static const oe_ecall_info_t _fileencryptor_ecall_info_table[] = 
{
...
oe_result_t fileencryptor_initialize_encryptor(
    ...
    encryption_header_t* header)
{
    ...
    if (password)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.password_len, sizeof(char));
    if (header)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, sizeof(encryption_header_t));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(initialize_encryptor_args_t));
    if (header)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(encryption_header_t));
    ...
    if (header)
        OE_WRITE_IN_OUT_PARAM(header, 1, sizeof(encryption_header_t), encryption_header_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fileencryptor_ecall_info_table[fileencryptor_fcn_id_initialize_encryptor].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_IN_OUT_PARAM(header, 1, sizeof(encryption_header_t));
...
OE_WEAK_ALIAS(fileencryptor_initialize_encryptor, initialize_encryptor);

oe_result_t fileencryptor_encrypt_block(
    oe_enclave_t* enclave,
    int* _retval,
    bool encrypt,
    unsigned char* input_buf,
    ...
    size_t size)
{
    ...
    if (input_buf)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.size, sizeof(unsigned char));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(encrypt_block_args_t));
    if (output_buf)
        OE_ADD_ARG_SIZE(_output_buffer_size, _args.size, sizeof(unsigned char));
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fileencryptor_ecall_info_table[fileencryptor_fcn_id_encrypt_block].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(output_buf, _args.size, sizeof(unsigned char));
...
OE_WEAK_ALIAS(fileencryptor_encrypt_block, encrypt_block);

oe_result_t fileencryptor_close_encryptor(oe_enclave_t* enclave)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fileencryptor_ecall_info_table[fileencryptor_fcn_id_close_encryptor].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fileencryptor_close_encryptor, close_encryptor);

oe_result_t fileencryptor_oe_get_sgx_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fileencryptor_ecall_info_table[fileencryptor_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fileencryptor_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t fileencryptor_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    size_t* report_buffer_size)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fileencryptor_ecall_info_table[fileencryptor_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fileencryptor_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t fileencryptor_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fileencryptor_ecall_info_table[fileencryptor_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fileencryptor_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t fileencryptor_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fileencryptor_ecall_info_table[fileencryptor_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fileencryptor_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t fileencryptor_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _fileencryptor_ecall_info_table[fileencryptor_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(fileencryptor_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);
...
static oe_ocall_func_t _fileencryptor_ocall_function_table[] = {
    ...
    oe_enclave_t** enclave)
{
    return oe_create_enclave(
               ...
               settings,
               setting_count,
               _fileencryptor_ocall_function_table,
               83,
               _fileencryptor_ecall_info_table,
                8,
               enclave);
}
